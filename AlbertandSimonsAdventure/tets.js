...
["", "", "", "", "horserideright",
 ...
 function loadLevel () {
	 ...
	 if (currentLevel % 5 == 0 && currentLevel != 0 && currentLevel != 20) {
		message1 = "Greetings Traveler! Step on the chest to receive some nice prinzes to help you on your journey! I'll keep your enemies at bay!";
		message2 = "";
...
// animate second enemy
 ...
 function tryToMove (direction) {
	 ...
	 let nextClass2 = 0; //class of location we wish to mvoe to
	...
	if (nextLocation != 25) {
	 ...
	 if (nextClass.includes("fence")){
		 ...
		 if(riderOn) {
			...
			// if direction is up or down and fence is wrong direction, don't move
            if(direction == "down" && nextClass == "fenceup"  direction == "up" && nextClass == "fenceup"){
                return;
            } else if(direction == "left" && nextClass == "fenceside"  direction == "right" && nextClass == "fenceside"){
                return;
            } // else if
            ...
            if(direction == "left"){
                ...
                nextLocation2 = nextLocation + 1;
            } else if(direction == "up" && nextClass != "fenceup"){
                nextClass = "jumpup";
                nextClass2 = "horserideup";
                nextLocation2 = nextLocation - widthOfBoard;
            } else if(direction == "down" && nextClass != "fenceup"){
                nextClass = "jumpdown";
            ...
            gridBoxes[currentLocationOfRobot].className = "";
	...
	if (nextClass.includes("door1")) {
	 ...
	 document.getElementById("levelup").style.display = "none";
	 currentLevel++;
	 document.getElementById("level").style.display = currentLevel;
	 loadLevel();
	 }, 1000);
	} //else if
