 ...
 * 			zookeeper.
 **********************************************************/
public class MonkeyEntity extends Entity {
   ...
   */
  public MonkeyEntity(Game g, String r, int newX, int newY) {
  ...
  public void move (long delta){
   ...
   public void collidedWith(Entity other) {
	   if (other instanceof NonLivingEntity || other instanceof ScoreEntity) {
          return;
      } // if
